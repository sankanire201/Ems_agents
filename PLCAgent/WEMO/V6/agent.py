...
class Loadprorityagent(Agent):
    ...
    def Check_Shedding_condition(self):
        total_consumption=self.Read_Total_Power_Consumption_sql()
        ...
        #print('uppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppper'+str(self.Power_Consumption_Upper_limit))
    ...
    def Read_Total_Power_Consumption_sql(self):
        ...
        for x in self.WeMo_Actual_Status.keys():
            ...
            print('#####################################################Read_WeMO'+' '+str(mqqt_topic)+' '+str(self.WeMo_Power_Consumption_Sql[x]))
