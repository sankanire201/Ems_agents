...
class Loadprorityagent(Agent):
        ...
        if os.path.isfile(self.csv_path):
         ...
         #iterate over the line of the csv
             ...
             for point in reader:
                     ...
                     Topic=Building+"/Wemo_cc"+Cluster_Controller+"/"+Name
                     if Name=='\t\t\t':
                         pass
                     else:
    ...
    def Send_Request(self,WeMo,CC):
        ...
        try:
            print("sending requests to cluster controller for "+WeMo)
            result=self.vip.rpc.call('platform.driver','set_point', self.WeMo_Topics[WeMo],'status',self.WeMo_Scheduled_Status[WeMo],external_platform='WeMo_cc_1').get(timeout=60)
            print(result)
            if result['status']==11:
    ...
    def Read_WeMo_Power_Consumption(self):
        pass
    ...
    def Schedule_WeMo(self):
        ...
        for x,y in self.WeMo_Priorities.items():
           ...
           # print(y)
            ...
            for P in y:
                Wemo_Power_Consumption_List[P[0]]=P[1]
